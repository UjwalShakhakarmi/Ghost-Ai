...
export default function SignInPage() {
  return (
    <div className="flex min-h-screen w-full bg-base text-copy-primary">
      {/* Left Panel */}
      <div className="hidden lg:flex flex-1 flex-col justify-between border-r border-surface-border bg-surface p-16">
        {/* Brand Header */}
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-brand shadow-sm">
            <span className="font-bold text-bg-base text-lg">G</span>
          </div>
        ...
        <div className="space-y-8 max-w-xl">
          <div>
            ...
            <p className="text-base text-copy-muted leading-relaxed">
          ...
          <div className="space-y-6 pt-2">
            <div className="flex items-start gap-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-accent-dim border border-surface-border text-brand shrink-0 mt-0.5">
